...
/**
 * Second pass of LLM taxonomy tags, after pulling prod's DB and tagging the
 * recipes that only existed on prod (plus a few under-tagged ones). Additive
 * and idempotent — adds mapped categories by slug match, never removes.
 */
class m260827_190000_recipe_taxonomy_tags_update extends Migration
{
